...
public class AVLTreeDeletion {
	...
	System.out.println();
		...
		System.out.println();
		System.out.println();
		/*head=delete(head,9);//return new root of tree 
...
*/
	...
	public static Tree delete(Tree node,int value)
	{
		...
		if(node.data==value)
		{
			...
			if(node.left!=null && node.right!=null)
			{
				...
				System.out.println("deleting successor ");
	...
	public static Tree findSuccessor(Tree rightSubTreeNode)
	{
